    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
        ...
        if (tk.getVaiTro().toLowerCase(Locale.ROOT).equals("nhanvien")) {
            if (uri.contains("chuyenphongban") || uri.contains("danhgia")
                    || uri.contains("duyetnghiphep") || uri.contains("tinhluong")|| uri.contains("nghiphep?action=duyet")|| uri.contains("nghiphep?action=tuchoi")|| uri.contains("hopdong")|| uri.contains("danhgia")|| uri.contains("nghiphep?action=duyet")) {
